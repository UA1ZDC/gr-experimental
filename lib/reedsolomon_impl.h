...
#ifndef INCLUDED_EXPERIMENTAL_REEDSOLOMON_IMPL_H
#define INCLUDED_EXPERIMENTAL_REEDSOLOMON_IMPL_H
...
#endif /* INCLUDED_EXPERIMENTAL_REEDSOLOMON_IMPL_H */
